...
public class Server implements Runnable{
    ...
    public Server(int portNumber, int backlog, userinterface.UserInterface myUI,client.Client myClient) {
        this.portNumber = portNumber;
        this.backlog = backlog;
        this.myUI = myUI;
        this.myClientCommandHandler = new clientmessagehandler.ClientMessageHandler(this, myClient);
        ...
        while (true) {
            if (doListen == true) {
                try {
                    ...
                    myClient.connectToServer();                 // Added this method for Proxy Client
                    clientconnection.ClientConnection myCC = new clientconnection.ClientConnection(clientSocket, myClientCommandHandler, this, myClient);
